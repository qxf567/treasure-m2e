...
public final class DateUtil {
	...
	private static final SimpleDateFormat FORMAT_DATE = new SimpleDateFormat(YYYY_MM_DD);
	/** format instance: HH:mm:ss */
	private static final SimpleDateFormat FORMAT_TIME = new SimpleDateFormat(HH_MM_SS);
	
	private static final SimpleDateFormat COMPUTE_TIME = new SimpleDateFormat(HHMMSSSSS);
	/**
	 * private constructor
	 */
	private DateUtil() {
	...
	public static long getInterval(final Date start, final Date end) {
		...
		return (endCalendar.getTimeInMillis() - startCalendar.getTimeInMillis()) / DAY_IN_MILLI;
	}
